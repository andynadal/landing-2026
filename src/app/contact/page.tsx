    ...
    <main className="min-h-screen bg-background pt-20 md:pt-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-base md:text-lg text-foreground/60 max-w-2xl mx-auto">
              ...
              or interesting ideas. Let&apos;s build something amazing together.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full px-8 py-4 rounded-lg bg-gradient-to-r from-green-600 to-blue-600 text-white font-medium hover:shadow-lg hover:shadow-green-500/50 transition-all duration-300"
              >
                Send Message
              </motion.button>
            </form>
      ...
      <section className="py-20 md:py-32">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold">Open to Opportunities</h2>
            <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
              Whether you&apos;re looking for a technical co-founder, a consultant for your
              project, or just want to discuss the latest in tech and entrepreneurship,
            ...
            <div className="pt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 rounded-2xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-foreground/10">
                ...
                <p className="text-sm text-foreground/60">Technical advisory & strategy</p>
              </div>
              <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-foreground/10">
                ...
                <p className="text-sm text-foreground/60">Co-founding & collaboration</p>
              </div>
              <div className="p-6 rounded-2xl bg-gradient-to-br from-green-500/10 to-blue-500/10 border border-foreground/10">
                ...
                <p className="text-sm text-foreground/60">Events & workshops</p>
              </div>
            </div>
          </motion.div>
        </div>
