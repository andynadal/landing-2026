...
export default function Home() {
  return (
    <main className="min-h-screen bg-background">
      ...
      >
        {/* Pausa Section */}
        <motion.section variants={itemVariants} className="mb-20 md:mb-32">
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <p className="text-lg text-foreground/70">
                  My current startup revolutionizing how people manage their time and productivity.
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 order-1 md:order-2">
              ...
              >
                ...
                <p className="text-lg text-foreground/70">
                  Explore my portfolio of innovative projects, from cutting-edge web applications
                  to scalable cloud solutions.
                </p>
              </motion.div>
              <Link
                href="/projects"
