...
const blogPosts = [
  {
    ...
    excerpt: "Insights and challenges from building an AI-powered productivity platform from scratch.",
    date: "December 2024",
  ...
  },
  {
    ...
    excerpt: "Exploring how technology is reshaping the way we think about productivity and rest.",
    date: "November 2024",
  ...
  },
  {
    ...
    excerpt: "Technical insights on building systems that can handle millions of users.",
    date: "October 2024",
  ...
  },
  {
    ...
    excerpt: "How I transitioned from writing code to building companies and what I learned along the way.",
    date: "September 2024",
    category: "Career",
    readTime: "6 min read",
  ...
  },
  {
    ...
    excerpt: "Practical applications of AI/ML and how to integrate them into your products.",
    date: "August 2024",
    category: "Technology",
    readTime: "8 min read",
  ...
  },
  {
    ...
    excerpt: "Strategies for creating and leading effective technical teams that deliver results.",
    date: "July 2024",
    category: "Leadership",
    readTime: "5 min read",
    ...
    <main className="min-h-screen bg-background pt-20 md:pt-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-foreground/80 max-w-3xl mx-auto">
              Thoughts on technology, entrepreneurship, and building products
            </p>
            <p className="text-base md:text-lg text-foreground/60 max-w-2xl mx-auto">
              Sharing insights, lessons learned, and perspectives from the intersection
              ...
              >
                <div className="h-full p-8 rounded-2xl bg-background border border-foreground/10 hover:border-foreground/20 transition-all duration-300 hover:shadow-xl flex flex-col">
                  ...
                  <div className="pt-4 border-t border-foreground/10">
                    <button className={`inline-flex items-center text-sm font-medium bg-gradient-to-r ${post.gradient} bg-clip-text text-transparent group-hover:underline`}>
                      Read Article
                      <svg
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-foreground/70 mb-8 max-w-2xl mx-auto">
              Get notified when I publish new articles on technology, entrepreneurship,
      ...
      <section className="py-20 md:py-32 bg-gradient-to-b from-foreground/5 to-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Topics I Write About</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2">Startups & Products</h3>
              <p className="text-foreground/70">Building and scaling products from idea to launch</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <p className="text-foreground/70">Technical deep-dives and best practices</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <p className="text-foreground/70">Building and leading technical teams</p>
            </motion.div>
          </div>
        </div>
      </section>
