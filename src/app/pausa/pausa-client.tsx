                    ...
                    >
                        ...
                        >
                            <p className="text-xl md:text-2xl text-foreground/90 leading-relaxed">
                                ...
                                don&apos;t meditate — and don&apos;t want to.
                            </p>
            ...
            <section className="py-12 md:py-20 bg-foreground/5">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <motion.ul
                            variants={staggerContainer}
                            className="space-y-3 text-lg text-foreground/70 ml-6"
                        >
                            ...
                            <motion.li variants={fadeInItem}>
                                your body is on edge and your mind won&apos;t
                                cooperate
                            </motion.li>
                        </motion.ul>
                        ...
                        <motion.div
                            variants={staggerContainer}
                            className="space-y-2 text-lg text-foreground/70 leading-relaxed pt-6"
                        >
                            <motion.p variants={fadeInItem}>
                                No rituals. No spirituality. No pressure to
                                &quot;feel calm.&quot;
                            </motion.p>
                            <motion.p
                                variants={fadeInItem}
                            ...
                            >
                                Just breathe. Then continue with your life.
                            </motion.p>
                        </motion.div>
                        ...
                        >
                            Pausa treats breathing as infrastructure, not
                            inspiration.
                        </motion.p>
                    </motion.div>
                </div>
            ...
            <section className="py-12 md:py-20">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <motion.div
                            variants={staggerContainer}
                            className="space-y-3 text-lg text-foreground/80 leading-relaxed"
                        >
                            <motion.p variants={fadeInItem}>
                                One day, my body collapsed before my mind
                                understood what was happening.
                            </motion.p>
                            <motion.p variants={fadeInItem} className="pl-4">
                                My heart started racing. My vision narrowed. My
                                left arm went numb.
                            </motion.p>
                        </motion.div>
                        ...
                        >
                            <motion.p variants={fadeInItem}>
                                I genuinely thought I was having a stroke. I was
                        ...
                        >
                            <motion.p variants={fadeInItem}>
                                In that moment, logic disappeared. All I had was
                                fear and a body completely out of control.
                            </motion.p>
                        </motion.div>
                        ...
                        >
                            <motion.p variants={fadeInItem}>
                                Later, I learned it was a panic attack. But in
                                the moment, labels didn&apos;t matter — survival
                                did.
                            </motion.p>
                        </motion.div>
                        ...
                        >
                            ...
                            >
                                What stayed with me wasn&apos;t the fear. It was
                                the realization that I had no reliable tool to
                                regulate my own body under stress.
                            </motion.p>
                            ...
                            >
                                That experience changed how I think about mental
                                health forever.
                            </motion.p>
                            ...
                            >
                                Pausa exists because panic doesn&apos;t ask for
                                permission — and help needs to be faster than
                                fear.
                            </motion.p>
                        </motion.div>
                    </motion.div>
            ...
            <section className="py-12 md:py-20 bg-foreground/5">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        >
                            <motion.p variants={fadeInItem}>
                                I didn&apos;t build Pausa because I love
                                wellness. I built it because most wellness tools
                        ...
                        >
                            <motion.p
                                ...
                                className="text-lg text-foreground/80 leading-relaxed"
                            >
                                When you&apos;re anxious, overwhelmed, or close
                                to panic, you don&apos;t want:
                            </motion.p>

                            <motion.ul
                                variants={staggerContainer}
                                className="space-y-2 text-lg text-foreground/70 ml-6"
                            >
                                <motion.li variants={fadeInItem}>
                                    long explanations
                                </motion.li>
                        ...
                        >
                            ...
                            >
                                ...
                                Moments where motivation is gone, discipline is
                                gone, and you just need relief.
                            </motion.p>
                        </motion.div>
                    </motion.div>
                </div>
                ...
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                Pausa is not meditation. It&apos;s nervous
                                system regulation.
                            </motion.p>
                        </motion.div>
                        ...
                        >
                            <motion.p variants={fadeInItem}>
                                Breathing is the fastest way to communicate
                                safety to the body. Pausa removes everything
                                that gets in the way of doing that.
                            </motion.p>
                        </motion.div>
                        ...
                        <motion.div
                            variants={staggerContainer}
                            className="space-y-3 text-lg text-foreground/70 leading-relaxed"
                        >
                            <motion.p variants={fadeInItem}>
                                Short sessions. Clear guidance. Evidence-based
                                techniques.
                            </motion.p>
                            <motion.p variants={fadeInItem}>
                        ...
                        <motion.p
                            ...
                            className="text-xl md:text-2xl font-medium text-foreground pt-4 leading-relaxed"
                        >
                            Pausa respects your time, your intelligence, and
            ...
            <section className="py-12 md:py-20 bg-foreground/5">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        >
                            <motion.p variants={fadeInItem}>
                                Pausa is a product-led company built from first
                                principles.
                            </motion.p>
                        </motion.div>
                        ...
                        >
                            <motion.p
                                ...
                                className="text-lg text-foreground/80 leading-relaxed"
                            >
                                It&apos;s designed, engineered, and iterated
                                obsessively with one question in mind:
                            </motion.p>
                            ...
                            >
                                &quot;Will this help someone when they&apos;re
                                not okay?&quot;
                            </motion.p>
                            ...
                            <motion.p
                                ...
                                className="text-xl font-medium text-foreground leading-relaxed"
                            >
                                Pausa reflects how I build companies: systems
                                over vibes, outcomes over appearances.
                            </motion.p>
                        </motion.div>
                    </motion.div>
                </div>
            ...
            <section className="py-12 md:py-20">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        >
                            <motion.p variants={fadeInItem}>
                                If you deal with stress, anxiety, or mental
                                overload — you don&apos;t need more motivation.
                            </motion.p>
                            ...
                            >
                                You need a tool that works when motivation is
                                gone.
                            </motion.p>
                        </motion.div>
                        ...
                        >
                            ...
                            <motion.p
                                ...
                                className="text-xl md:text-2xl font-medium text-foreground leading-relaxed"
                            >
                                It&apos;s something you&apos;re grateful to have
                                when things spiral.
                            </motion.p>
                        </motion.div>
                    </motion.div>
                    ...
                    >
                        ...
                        >
                            <motion.p
                                ...
                                className="text-xl md:text-2xl font-medium text-foreground leading-relaxed"
                            >
                                If your mind runs fast and your body pays the
                                price, download Pausa.
                            </motion.p>
                            ...
                            <motion.p
                                ...
                                className="text-lg text-foreground/80 leading-relaxed"
                            >
                                Use it once. Your nervous system will
                                understand.
                            </motion.p>
                        </motion.div>
